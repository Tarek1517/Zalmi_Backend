...
Route::get('/header-categories', [App\Http\Controllers\Api\V1\Frontend\CategoryController::class, 'headerCategories']);
Route::get('/home-products', [App\Http\Controllers\Api\V1\Frontend\ProductController::class, 'homeProducts']);
Route::get('/parent-category', [App\Http\Controllers\Api\V1\Frontend\CategoryController::class, 'parentCategory']);
