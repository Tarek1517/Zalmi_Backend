...
<body
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <!-- Welcome to Zalmi section -->
                <div class="flex flex-col items-center justify-center text-center w-full p-6 lg:p-8">
                    <h1 class="text-3xl lg:text-5xl font-medium  mb-4">
                        Welcome to <span class="text-[#eb25d1] dark:text-[#eb25d1]">Zalmi</span>
                    </h1>
                </div>
            </main>
        </main>
